...
# samples for SOS
TChiNeuWZ_mCh100_mChi100_mChi95 = kreator.makeMCComponentFromEOS('TChiNeuWZ_mCh100_mChi100_mChi95','/TChiWZDeg_miniAODSIM_76X_lepOnly_dM5gev/','/store/user/castello/susy/%s',".*root",22.67*0.112)
TChiNeuWZ_mCh100_mChi100_mChi90 = kreator.makeMCComponentFromEOS('TChiNeuWZ_mCh100_mChi100_mChi90','/TChiWZDeg_miniAODSIM_76X_lepOnly_dM10gev/','/store/user/castello/susy/%s',".*root",22.67*0.112)
TChiNeuWZ_mCh100_mChi100_mChi80 = kreator.makeMCComponentFromEOS('TChiNeuWZ_mCh100_mChi100_mChi80','/TChiWZDeg_miniAODSIM_76X_lepOnly_dM20gev/','/store/user/castello/susy/%s',".*root",22.67*0.112)
TChiNeuWZ_mCh150_mChi120_OS = kreator.makeMCComponentFromEOS('TChiNeuWZ_mCh150_mChi120_OS', '/TChiNeuWZ_mCh150_mChi120_OS/', '/store/group/phys_susy/cheidegg/EWKSignals_76X_MiniAODv2/%s', ".*root", 5.18086 *(3*0.03366))
...
backgrounds = [TTJets_SingleLeptonFromT,TTJets_SingleLeptonFromTbar,TTJets_DiLepton,ZZTo2L2Nu,WWTo2L2Nu,WZTo3LNu,DYJetsToLL_M5to50_LO,DYJetsToLL_M50_LO,WJetsToLNu_LO]
